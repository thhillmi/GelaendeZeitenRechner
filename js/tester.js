    ...
    return {
        ...
        strings: {
            ...
            en: {
                ...
                step2Desc: 'On the Google Play page you\'ll see a "Become a tester" button. Tap it to register as a tester.After this click on "download it on Google PLay"',
                step3Title: 'Install the app',
                step3Desc: 'After registering, you can install EquiPace for free from the Play Store. The price button will be shown but if you click on it a Tester Tab is shown witht the info that nothing is charged. And you can Install it',
